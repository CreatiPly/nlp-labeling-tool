...
frame_left = Frame(nlp_text_labeling_tool, background="blue")
...
frame_mid = Frame(nlp_text_labeling_tool, background="red")
...
button_frame = Frame(frame_mid, background="lightgray")
...
frame_right_up = Frame(nlp_text_labeling_tool, background="green")
frame_right_up.grid(row=0, column=2, sticky="nsew")

# RIGHT SIDE BAR : DOWN

frame_right_down = Frame(nlp_text_labeling_tool, background="yellow")
